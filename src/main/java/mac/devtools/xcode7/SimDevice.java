...
import mac.NSObject;
import mac.devtools.xcode7.protocol.SimDeviceNotifier;
...
public class SimDevice extends NSObject implements SimDeviceNotifier {
	...
	public native boolean bootWithOptionsError(
			@Mapped(ObjCObjectMapper.class) Object arg1, Ptr<NSError> arg2);
	...
	public native int launchApplicationWithIDOptionsError(
			String arg1,
			NSDictionary arg2, Ptr<NSError> arg3);
	...
	public native String stateString();
