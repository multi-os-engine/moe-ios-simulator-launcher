...
+ (SimDeviceSet *)setForSetPath:(NSString *)arg1;
...
- (void)handleXPCNotification:(id)arg1;
- (BOOL)deleteDevice:(SimDevice *)arg1 error:(NSError **)arg2;
- (void)deleteDeviceAsync:(SimDevice *)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (unsigned long long)registerNotificationHandlerOnQueue:(id)arg1 handler:(CDUnknownBlockType)arg2;
- (unsigned long long)registerNotificationHandler:(CDUnknownBlockType)arg1;
- (void)removeDeviceAsync:(SimDevice *)arg1;
- (void)addDevice:(SimDevice *)arg1;
- (void)addDeviceAsync:(SimDevice *)arg1;
- (void)updateDefaultDevices;
- (NSString *)defaultCreatedPlistPath;
